...
export const allSub = [
  ...
  // { subName: "Programming", subPath: "Programming" },
  // { subName: "Science", subPath: "Science" },
  // { subName: "Writing", subPath: "Writing" },
  // { subName: "Health & Medical", subPath: "Health-&-Medical" },
  // { subName: "Economics", subPath: "Economics" },
  // { subName: "Engineering", subPath: "Engineering" },
  {
    subName: "Computer Science",
    subPath: "computer-sci",
  },
  // { subName: "Law", subPath: "Law" },
  // { subName: "Foreign Languages", subPath: "Foreign-Languages" },
];
...
export const softwareEngineerSub = [
  ...
  // { subName: "Data Structures", subPath: "Data-Structures" },
  // { subName: "Software Design", subPath: "Software-Design" },
  // { subName: "Operating Systems", subPath: "Operating-Systems" },
  // { subName: "Database Management", subPath: "Database-Management" },
  // { subName: "Cybersecurity", subPath: "Cybersecurity" },
  // { subName: "Cloud Computing", subPath: "Cloud-Computing" },
];

export const networkEngineerSub = [
  { subName: "Mathematics", subPath: "Mathematics" },
  { subName: "Engineering", subPath: "Engineering" },
  { subName: "Computer Science", subPath: "Computer-Science" },
  { subName: "Networking", subPath: "Networking" },
  { subName: "Network Security", subPath: "Network-Security" },
  { subName: "Telecommunications", subPath: "Telecommunications" },
  { subName: "Routing & Switching", subPath: "Routing-&-Switching" },
  { subName: "Wireless Communication", subPath: "Wireless-Communication" },
  { subName: "Cloud Networking", subPath: "Cloud-Networking" },
  { subName: "Network Protocols", subPath: "Network-Protocols" },
  { subName: "Internet of Things (IoT)", subPath: "Internet-of-Things-IoT" },
  { subName: "Cybersecurity", subPath: "Cybersecurity" },
];
